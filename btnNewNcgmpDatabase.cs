...
{
    public class btnNewNcgmpDatabase : ESRI.ArcGIS.Desktop.AddIns.Button
    {
        public btnNewNcgmpDatabase()
        {
        }
        ...
        protected override void OnClick()
        {
            ...
            // The XML doc is provided through Properties.Resources, but must be copied out to a local file for ArcObjects to use it
            ...
            try
            {
                ...
                // Perform the import
                    ...
                    xmlImporter.ImportWorkspace(tempFilePath, enumNameMapping, openedWorkspace, true);
                }
            catch (Exception ex)
            {
        ...
        {
            // Only available if you are not editing
            Enabled = ArcMap.Editor.EditState == ESRI.ArcGIS.Editor.esriEditState.esriStateNotEditing;
        }
    }
}
